...
type Service interface {
	...
	create(req createRequest) (err error)
...
func (cs *categoryService) create(c createRequest) (err error) {
	err = c.Validate()
	if err != nil {
	...
	err = cs.store.CreateCategory(&db.Category{
		Name: c.Name,
	})
	if err != nil {
...
// func (cs *categoryService) deleteByID(id string) (err error) {
